...
$(document).ready(function() {
	  $('#contactType').change(function() {
	    var result = $('#contactType option:selected').val();
	    if (result == 'bugreport') {
	      $('.layer').show();
	    } else {
	      $('.layer').hide();
		...
		<div class="wow fadeInUp col-md-6 col-sm-12" data-wow-delay="1.6s">
			...
			<div class="contact-form">
				<form id="contact-form" method="post" action="contact_insert.do">
					...
					<!--  만약 contactType가 bug report이라면, portNum을 입력받고, 아니라면 보이지 않게끔 -->
					<div class="layer">
						<input name="portNum" type="text" class="form-control" placeholder="Portfolio Number" required>
					</div>
						<!-- 여기도 Choose태그로 만들어서, 현재까지 존재하는 포트폴리오의 제목을 선택할 수 있게끔 한다.-->
